const ContactIFrameSection = () => {
  return (
    <section className="relative py-10 px-5 md:mb-20 sm:px-8 md:px-16 xl:px-32 2xl:px-[64px] max-w-[1440px] mx-auto">
      <div className="max-w-[1200px] mx-auto text-center">
        <h2 className="text-[24px] lg:text-[44px] text-[#650E45] font-bold mb-5 leading-snug">
          Find us easily,<br />
          right at the heart of <span className="text-[#650E45]/80">Coimbatore</span> district
        </h2>
